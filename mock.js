const menu = [
  ...
  {
    name: 'Categoria Grande',
    url: '',
  },
  {
    name: 'Categoria Muito Grande',
    url: '',
    nodes: [
      {
...
const dataMock = {
  ...
  footer: {
    logo: '',
    name: 'Test Shop',
    logoCaption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer placerat urna nisi',
    ...
    socialNetworks: [
      ...
      },
      {
        account: 'youtube tes',
        name: 'youtube',
        url: 'https://youtube.com/test_shop',
      },
    ],
    address: {
